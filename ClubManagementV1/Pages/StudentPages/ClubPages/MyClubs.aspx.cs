...
namespace ClubManagementV1.Pages.StudentPages.ClubPages
{
    public partial class MyClubs : System.Web.UI.Page
    {
        ...
        public IEnumerable<Models.Club> GetMyClubs()
        {
            DataSet clDs = Repository.GetDataSet(string.Format("select * from club where clubID in (select clubID from clubMembership where studentID='{0}')",Sid), "club");
